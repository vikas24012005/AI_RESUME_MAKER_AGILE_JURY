...
function HomePage() {
  ...
  const handleClick = () => {
    // Replace 'https://github.com' with the actual GitHub URL you want to navigate to
    window.open("https://github.com", "_blank"); // Opens GitHub in a new tab/window
  };
  ...
  return (
    <>
          ...
          <div className="w-full mx-auto mt-20 text-center md:w-10/12">
            <div className="relative z-0 w-full mt-8">
              <div className="relative overflow-hidden shadow-2xl">
                ...
                <img
                  className="object-cover py-2 px-4 rounded-b-lg"
                  src={heroSnapshot}
                  alt="Dashboard"
                />
              </div>
      ...
      <footer class="bg-white" aria-labelledby="footer-heading">
        <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 p-5 flex justify-between">
